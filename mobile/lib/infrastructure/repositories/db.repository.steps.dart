...
class Shape30 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get role =>
      columnsByName['role']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<bool> get showInTimeline =>
      columnsByName['show_in_timeline']! as i1.GeneratedColumn<bool>;
}
...
final class Schema21 extends i0.VersionedSchema {
  ...
  late final Shape30 remoteAlbumUserEntity = Shape30(
    source: i0.VersionedTable(
      entityName: 'remote_album_user_entity',
      withoutRowId: true,
      isStrict: true,
      tableConstraints: ['PRIMARY KEY(album_id, user_id)'],
      columns: [_column_60, _column_25, _column_61, _column_103],
      attachedDatabase: database,
    ),
    alias: null,
  );

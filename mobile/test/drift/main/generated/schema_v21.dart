...
class RemoteAlbumUserEntity extends Table
  ...
  late final GeneratedColumn<bool> showInTimeline = GeneratedColumn<bool>(
    'show_in_timeline',
    aliasedName,
    false,
    type: DriftSqlType.bool,
  ...
  @override
  List<GeneratedColumn> get $columns => [albumId, userId, role, showInTimeline];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class RemoteAlbumUserEntityData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['show_in_timeline'] = Variable<bool>(showInTimeline);
    return map;
  }
...
class RemoteAlbumUserEntityCompanion
  ...
  final Value<bool> showInTimeline;
  ...
  RemoteAlbumUserEntityCompanion.insert({
    ...
    required String userId,
    required int role,
    Value<bool> showInTimeline = const Value.absent(),
  }) : albumId = Value(albumId),
       userId = Value(userId),
       role = Value(role),
  ...
  static Insertable<RemoteAlbumUserEntityData> custom({
    ...
    Expression<String>? userId,
    Expression<int>? role,
    Expression<bool>? showInTimeline,
  }) {
    return RawValuesInsertable({
      if (albumId != null) 'album_id': albumId,
      if (userId != null) 'user_id': userId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (showInTimeline.present) {
      map['show_in_timeline'] = Variable<bool>(showInTimeline.value);
    }
    return map;
  }
